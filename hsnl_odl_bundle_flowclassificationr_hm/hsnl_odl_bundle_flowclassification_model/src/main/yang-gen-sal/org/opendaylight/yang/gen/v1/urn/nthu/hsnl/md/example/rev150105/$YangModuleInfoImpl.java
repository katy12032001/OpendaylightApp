...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "flowclassification";
    private final String namespace = "urn:nthu:hsnl:md:example";
    private final String revision = "2015-01-05";
    private final String resourcePath = "/META-INF/yang/flowclassification.yang";
